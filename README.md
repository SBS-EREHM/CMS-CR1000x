...
These CRBasic programs assume sensor(s) are polled, i.e., an RS-232 or SDI-12 command summons data from the sensor.

* ECO-SUNA-Polled.CR1X
* **ECO-SUNA-SeapHOx-EXO-Polled.CR1X   (Deployment)**
